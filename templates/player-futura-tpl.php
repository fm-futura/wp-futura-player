<div class="player__container" id="<?php echo $player_id ?>">
      <img src="<?php echo $player_base_url . '/templates/' ?>vivo.svg"  class="player__branding" />
      <div class="player__content">
        <div class="player__control">
        <img src="<?php echo $player_base_url . '/templates/' ?>play.svg"  class="player__play"  />
        <img src="<?php echo $player_base_url . '/templates/' ?>pause.svg" class="player__pause" />
        </div>
